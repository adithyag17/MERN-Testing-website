...
import Picture from '../../95399-light-bulb-moment.gif'
    ...
    render() {
        ...
        return (
            <div className="auth-wrapper">
                ...
                <div className="right">
                    <div className="header">Dokimi Test Platform</div>
                    <div className="sub-header" style={{marginTop:"20px"}}>MCQs but simpler</div>
                    {page}
                    <div className="new" onClick={this.changeTab}>{this.state.tab === 'signin' ? 'New user? Sign up here' : 'Already have an account with us? Sign in'}</div>
                </div>
            </div>
        )
    }
